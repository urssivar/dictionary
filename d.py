...
parser = argparse.ArgumentParser(prog='d.py', description='Kaitag dictionary tools')
...
p_val = sub.add_parser('validate', help='validate entries: structure, IDs, tags, schema')
p_val.add_argument('letters', nargs='*', help='letter folders to check (default: all)')
